...
//     
//
//        public void uniformCostSearch(String source, String destination, int[][] graphmatrix,ArrayList<String> nodelist ,int start_time, String[][] timeperiods)
//
//        {
//
//            int evaluationNode;
...
//     
////
////            for (int sourcevertex = 0; sourcevertex < nodelist.size(); sourcevertex++)
////
////            {
////
////                for (int destinationvertex = 0; destinationvertex < nodelist.size(); destinationvertex++)
////
////                {
////
////                    graphmatrix[sourcevertex][destinationvertex] =
////
////                           graphmatrix[sourcevertex[destinationvertex];
//
////    	    }
...
//
//            distances[nodelist.indexOf(start)] = 0;
//
//     
//
...
//     
//
//                UCS2 uniformCostSearch = new UCS2(number_of_vertices);
//
...
//
//        }
//if(visited[nodelist.indexOf(finaldestination[dest])]==0)
//    }